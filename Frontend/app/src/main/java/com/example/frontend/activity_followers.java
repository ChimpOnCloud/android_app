...
public class activity_followers extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                LoadingDialogUtil.getInstance(activity_followers.this).closeLoadingDialog();
                buildDialog("Error","无法连接至服务器。。或许网络出错了？",activity_followers.this);
                e.printStackTrace();
            }
